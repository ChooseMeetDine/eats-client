...
(function() {
	...
	L.Routing.Line = L.LayerGroup.extend({
		...
		options: {
			styles: [
				{color: '#212121', opacity: 0.15, weight: 9},
				{color: '#FAFAFA', opacity: 0.8, weight: 6},
				{color: '#00B8D4', opacity: 1, weight: 2}
			],
			missingRouteStyles: [
				{color: '#212121', opacity: 0.15, weight: 7},
				{color: '#FAFAFA', opacity: 0.6, weight: 4},
				{color: '#757575', opacity: 0.8, weight: 2, dashArray: '7,12'}
			],
			addWaypoints: true,
...
(function() {
	...
	L.Routing.Localization = {
		'en': {
			...
			ui: {
				startPlaceholder: 'Startdestination',
				viaPlaceholder: 'Via {viaNumber}',
				endPlaceholder: 'Slutdestination'
			}
		},
	...
	L.Routing.Plan = L.Class.extend({
		...
		options: {
			dragStyles: [
				{color: '#212121', opacity: 0.15, weight: 9},
				{color: '#FAFAFA', opacity: 0.8, weight: 6},
				{color: '#00B8D4', opacity: 1, weight: 2, dashArray: '7,12'}
			],
